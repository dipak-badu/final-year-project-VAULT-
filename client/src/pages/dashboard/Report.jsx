...
export default function Report() {
  ...
  return (
    <main className="flex flex-col min-h-screen p-4 sm:p-6 md:p-8 gap-10">
      <div className="grid lg:grid-cols-2 w-full gap-10 max-w-[1400px] mx-auto">
        <GridItems
...
function GridItems({ title, className = "", children }) {
  return (
    <div
      className={`flex flex-col items-center justify-center p-4 border border-white/10 rounded-lg bg-[#16161d] min-h-[420px] ${className}`}
    >
